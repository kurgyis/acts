...
class SeedingPerformanceWriter final
 ...
 public:
  ...
  //TODO Indexmultimap is now part of Index.hpp and behaves differently than before

  /// @brief Converts a seed to a proto track of 3 hits
  ActsExamples::ProtoTrack seedToProtoTrack(const Acts::Seed<SimSpacePoint>* seed) const;
